...
function sortedHightoLowPrice(hotel1,hotel2){
  return hotel2.price - hotel1.price;
}
function sortedLowtoHighPrice(hotel1,hotel2){
  return hotel1.price - hotel2.price;
}
app.get('/hotels/sort/pricing', (req, res) => {
  let pricing = req.query.pricing;
  let hotel = hotels.slice();
  if(pricing === 'low-to-high'){
    hotel.sort(sortedLowtoHighPrice);
  }
  else{
...
function sortedLowtoHighRating(hotel1,hotel2){
...
app.get('/hotels/sort/rating', (req,res)=>{
  ...
  if(rating === 'low-to-high'){
    hotel.sort(sortedLowtoHighRating);
  }
  else{
...
function sortedLeasttoMostReviews(hotel1,hotel2){
  return hotel1.views - hotel2.reviews;
}
...
app.get('/hotels/sort/reviews', (req,res)=>{
  ...
  if(reviews === 'least-to-most'){
    hotel.sort(sortedLeasttoMostReviews);
  }
  else{
